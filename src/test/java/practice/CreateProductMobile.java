...
public class CreateProductMobile {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
		...
		//Read TestScript from Excel
				...
				//String PRODUCT_NAME = wb.getSheet("Product").getRow(1).getCell(2).getStringCellValue();
				//String SELECT_CATEGORY = wb.getSheet("Product").getRow(1).getCell(3).getStringCellValue();
				//String QUANTITY = wb.getSheet("Product").getRow(1).getCell(4).getStringCellValue();
				//String PRICE_PER_UNIT = wb.getSheet("Product").getRow(1).getCell(5).getStringCellValue();
				//String SELECT_VENDOR = wb.getSheet("Product").getRow(1).getCell(6).getStringCellValue();
				//wb.close();
				...
				//productName.sendKeys(PRODUCT_NAME+jLib.generateRandomNumber());
				//select class
